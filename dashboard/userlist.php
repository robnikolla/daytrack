   ...
   <main style="display:flex;">
    ...
    <div class="main-content">
        ...
        <table class="detyratable">
           <h2 style="padding:0px 10px;">User Table</h2>
           <tr>
               <th>ID</th>
               <th>Full Name</th>
               <th>Email</th>
           ...
           ?>
               <tr>
                   ...
                   <td><?= $user["password"]?></td>
                   <td>
                    <a href="<?= "../func/updUser.php?ID=$user[ID]"?>"><button class="updatebtn">Update</button></a> 
                    <a href="<?= "../func/delUser.php?ID=$user[ID]"?>"><button class="deletebtn" >Delete</button></a>
                </td>
