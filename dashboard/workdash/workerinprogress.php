...
<header>
   ...
   <main style="display:flex;">
    ...
    <table class="detyratable">
           <h2 style="padding:0px 10px;">Tasks In Progress</h2>
           <tr>
               <th>ID</th>
               <th>Description</th>
               <th>Status</th>
           ...
           <?php 
           $dtr = new Detyra();
           $detyrat = $dtr->showYourInProgressDetyra();
               ...
               <tr>
                   ...
                   <td>
                    <div class="progcontainer">
                        <div class="progressbar" style="width:<?= $detyra["progress"] ?>%"><span style="padding-left:5px;color:white"> <?= $detyra["progress"] ?>%</span></div> 
                    </div> 
